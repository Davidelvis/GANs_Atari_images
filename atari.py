...
class InputWrapper(gym.ObservationWrapper):
    """
    Gym provides wrapper classes which help us to change the observation or tha actions
    The below function helps us to resize the images from Atari game, standard size (210x160) to square size (64x64)
    """
